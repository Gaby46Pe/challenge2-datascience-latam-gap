...
(Para usar SMOTE, necesitamoss la librería *imblearn*)
...
Compararemos un modelo basado en distancias/probabilidad (Regresión Logística) contra uno basado en árboles (Random Forest), se eligió la Regresión Logística por su interpretabilidad y el Random Forest por su capacidad para capturar relaciones no lineales entre variables.
 ...
 **Dimensión**	            **Conclusión del Análisis**
  ...
  **Principal Alerta**	    El **desbalanceo de clases** fue corregido con SMOTE,       
                            mejorando la detección de fugas
  **Factor de Riesgo #1**	**Contratos mensuales**: son el predictor más fuerte de       
                            cancelación
  **Recomendación**	        Priorizar la **retención proactiva** sobre la adquisición   
                            de nuevos clientes
